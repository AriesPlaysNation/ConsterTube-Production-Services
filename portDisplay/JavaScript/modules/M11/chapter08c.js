 ...
 *    Chapter 8 Chapter case
 *    Author: 	Vodnik/Gosselin
 *    Date:   	04/06/17
 *    Filename: chapter08c.js
 */
"use strict";
...
} // END FUNCTION VALIDATE USERNAME
...
function registerLodging(event) {
   ...
   } // END IF CALLER ELEMENT CHECKED
} // END FUNCTION REGISTER LODGING
...
function createEventListeners() {
   ...
   } // END IF UNINPUT ADD EVENT LISTENER
   ...
   } //END ELSE IF LODGINGS[0].ATTACHEVENT
   ...
   } // END IF BUTTON.ADDEVENTLISTENER
} // END FUNCTION CREATE EVENT LISTENERS
